...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2023 a las 15:00:14
...
--
-- Estructura de tabla para la tabla `tipoestadoproducto`
--

CREATE TABLE `tipoestadoproducto` (
  `idTipoEstadoProducto` int(11) NOT NULL,
  `descripcionEstadoProducto` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `tipoestadoproducto`
--
ALTER TABLE `tipoestadoproducto`
  ADD PRIMARY KEY (`idTipoEstadoProducto`);
...
--
-- AUTO_INCREMENT de la tabla `tipoestadoproducto`
--
ALTER TABLE `tipoestadoproducto`
  MODIFY `idTipoEstadoProducto` int(11) NOT NULL AUTO_INCREMENT;
